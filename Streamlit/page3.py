...
# Pointing to the correct data folder
...
with st.expander("🎯 Advanced Filters", expanded=True):
    ...
    selected_rating = col1.slider("Min. Average Rating", 0.5, 5.0, 3.5, 0.1)
    selected_votes = col2.slider("Min. Number of Votes", 0, int(movie_stats['rating_count'].max()), 50, 10)
...
if st.button("🔍 Run Search"):
    ...
    k1.metric("🎞️ Movie Count", len(filtered_movies))
    ...
    st.info("🧭 Set your filters, then click on **Run Search** to explore movies.")